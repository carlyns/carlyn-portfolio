...
;(function($, window, document, undefined){
    ...
    $.fn.AuxinIsotopeImageLayoutsInit = function( $scope ){
        ...
        $.fn.AuxinIsotopeGallaryInit( $scope );
    ...
    $.fn.AuxinIsotopeGallaryInit = function( $scope ){
        $scope = $scope || $(this);
...
;(function($, window, document, undefined){
    ...
    $.fn.AuxinDropdownEffectInit = function( $scope ){
        ...
        $scope.find('.aux-top-header, .site-header-section .aux-cart-wrapper').each(function() {
    ...
    $.fn.AuxinCartCanvasInit = function( $scope ){
        ...
        $scope.find('.aux-card-dropdown').clone().appendTo('#offcart .aux-offcart-content');

        var $burgerBasket = $scope.find('#shopping-basket-burger'),
        $burgerBasketIcon = $burgerBasket.find('>.aux-cart-contents'),
